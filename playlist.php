...
$password = ""; // mật khẩu
$dbname = "music_database"; // tên database
...
<body>
    ...
    <script>
        window.localStorage.setItem(
            "songs",
            JSON.stringify(<?php echo json_encode($rows); ?>));
    </script>
    <header>
        <div class="menu_side">
            <h1>PLAY MUSIC</h1>
        ...
        <div class="song_side">
            ...
            <!-- <div class="content">
                <div class="bia"></div>
                <h1>Về với em - Võ Hạ Trâm</h1>
                <p>Đây là bài hát đánh dấu sự trở lại đường đua âm nhạc của cô<br>Bài nhạc mang nhiều âm hưởng giao thoa
                    giữa nhạc Việt Nam và Ấn Độ</p>
                <div class="buttons">
                    <button>PLAY</button>
            ...
            <div class="popular_song">
                ...
                <div class="pop_song">
                    <li class="songItem">
                        <div class="img_play">
                            <!-- kiem' hinh` cho cai' nay` nha -->
                            <img src="img/neulucdo.jpg" alt="" />
                            <i class="bi playlistplay ri-play-circle-fill" id="6"></i>
                        </div>
                        <h5>Nếu lúc đó<br>
                            <div class="subtitle">Tlinh</div>
                        </h5>
                    ...
                    <li class="songItem">
                        <div class="img_play">
                            <!-- kiem' hinh` cho cai' nay` nha -->
                            <img src="img/honemchonao.jpg" alt="" />
                            <i class="bi playlistplay ri-play-circle-fill" id="7"></i>
                        </div>
                        <h5>Hơn em chổ nào<br>
                            <div class="subtitle">Thùy Chi</div>
                        </h5>
                    </li>
                    <li class="songItem">
                        <div class="img_play">
                            <!-- kiem' hinh` cho cai' nay` nha -->
                            <img src="img/honcayeu.jpg" alt="" />
                            <i class="bi playlistplay ri-play-circle-fill" id="8"></i>
                        </div>
                        <h5>Hơn cả yêu<br>
                    ...
                    <li class="songItem">
                        <div class="img_play">
                            <!-- kiem' hinh` cho cai' nay` nha -->
                            <img src="img/ngumotminh.jpg" alt="" />
                            <i class="bi playlistplay ri-play-circle-fill" id="9"></i>
                        </div>
                        <h5>Ngủ một mình<br>
                    ...
                    <li class="songItem">
                        <div class="img_play">
                            <!-- kiem' hinh` cho cai' nay` nha -->
                            <img src="img/sautatca.jpg" alt="" />
                            <i class="bi playlistplay ri-play-circle-fill" id="10"></i>
                        </div>
                        <h5>Sau tất cả<br>
                    ...
                    <li class="songItem">
                        <div class="img_play">
                            <!-- kiem' hinh` cho cai' nay` nha -->
                            <img src="img/tinhyeudensau.jpg" alt="" />
                            <i class="bi playlistplay ri-play-circle-fill" id="11"></i>
                        </div>
                        <h5>Tình yêu đến sau<br>
                    ...
                    <li class="songItem">
                        <div class="img_play">
                            <!-- kiem' hinh` cho cai' nay` nha -->
                            <img src="img/tatnuocdaudinh.jpg" alt="" />
                            <i class="bi playlistplay ri-play-circle-fill" id="12"></i>
                        </div>
                        <h5>Tát nước đầu đình<br>
                            <div class="subtitle">Binz - Lynk Lee</div>
                        </h5>
                    </li>
                    <li class="songItem">
                        <div class="img_play">
                            <!-- kiem' hinh` cho cai' nay` nha -->
                            <img src="img/ladoemxuithoi.jpg" alt="" />
                            <i class="bi playlistplay ri-play-circle-fill" id="13"></i>
                        </div>
                        <h5>Là do em xui thôi<br>
                            <div class="subtitle">SOFIA x KHÓI x CHÂU ĐĂNG KHOA - xR</div>
                        </h5>
                    </li>
                    <li class="songItem">
                        <div class="img_play">
                            <!-- kiem' hinh` cho cai' nay` nha -->
                            <img src="img/vohatram.jpg" alt="" />
                            <i class="bi playlistplay ri-play-circle-fill" id="14"></i>
                        </div>
                        <h5>Ưng quá chừng<br>
                    ...
                    <li class="songItem">
                        <div class="img_play">
                            <!-- kiem' hinh` cho cai' nay` nha -->
                            <img src="img/vohatram.jpg" alt="" />
                            <i class="bi playlistplay ri-play-circle-fill" id="15"></i>
                        </div>
                        <h5>Nhạc Anh<br>
                            <div class="subtitle">Andree ft Wxrdie</div>
                        </h5>
                    </li>
                    <li class="songItem">
                        <div class="img_play">
                            <!-- kiem' hinh` cho cai' nay` nha -->
                            <img src="img/vohatram.jpg" alt="" />
                            <i class="bi playlistplay ri-play-circle-fill" id="16"></i>
                        </div>
                        <h5>Về với em<br>
                            <div class="subtitle">Võ Hạ Trâm</div>
                        </h5>
                    </li>
                    <li class="songItem">
                        <div class="img_play">
                            <!-- kiem' hinh` cho cai' nay` nha -->
                            <img src="img/vohatram.jpg" alt="" />
                            <i class="bi playlistplay ri-play-circle-fill" id="17"></i>
                        </div>
                        <h5>Về với em<br>
                            <div class="subtitle">Võ Hạ Trâm</div>
                        </h5>
                    ...
                    <li class="songItem">
                        <div class="img_play">
                            <!-- kiem' hinh` cho cai' nay` nha -->
                            <img src="img/vohatram.jpg" alt="" />
                            <i class="bi playlistplay ri-play-circle-fill" id="18"></i>
                        </div>
                        <h5><br>
                            <div class="subtitle"></div>
                        </h5>
                    ...
                    <li class="songItem">
                        <div class="img_play">
                            <!-- kiem' hinh` cho cai' nay` nha -->
                            <img src="" alt="" />
                            <i class="bi playlistplay ri-play-circle-fill" id="19"></i>
                        </div>
                        <h5><br>
                            <div class="subtitle"></div>
                        </h5>
                    ...
                    <li class="songItem">
                        <div class="img_play">
                            <!-- kiem' hinh` cho cai' nay` nha -->
                            <img src="" alt="" />
                            <i class="bi playlistplay ri-play-circle-fill" id="20"></i>
                        </div>
                        <h5><br>
                            <div class="subtitle"></div>
                        </h5>
            ...
            <div class="popular_song">
                <div class="h4">
                    <h4>US-UK SONGS</h4>
                    <div class="btn_song">
                        <i class="bi ri-arrow-left-line" id="pop_song1_left"></i>
                        <i class="bi ri-arrow-right-line" id="pop_song1_right"></i>
                    </div>
                </div>
                <div class="pop_song">
                    <li class="songItem">
                        <div class="img_play">
                            <img src="" alt="" />
                            <i class="bi playlistplay ri-play-circle-fill" id="21"></i>
                        </div>
                        <h5>text<br>
                    ...
                    <li class="songItem">
                        <div class="img_play">
                            <img src="" alt="" />
                            <i class="bi playlistplay ri-play-circle-fill" id="22"></i>
                        </div>
                        <h5>text<br>
                            <div class="subtitle">text</div>
                        </h5>
                    ...
                    <li class="songItem">
                        <div class="img_play">
                            <img src="" alt="" />
                            <i class="bi playlistplay ri-play-circle-fill" id="23"></i>
                        </div>
                        <h5>text<br>
                            <div class="subtitle">text</div>
                        </h5>
                    ...
                    <li class="songItem">
                        <div class="img_play">
                            <img src="" alt="" />
                            <i class="bi playlistplay ri-play-circle-fill" id="24"></i>
                        </div>
                        <h5>text<br>
                            <div class="subtitle">text</div>
                        </h5>
                    ...
                    <li class="songItem">
                        <div class="img_play">
                            <img src="" alt="" />
                            <i class="bi playlistplay ri-play-circle-fill" id="25"></i>
                        </div>
                        <h5>text<br>
                            <div class="subtitle">text</div>
                        </h5>
                    ...
                    <li class="songItem">
                        <div class="img_play">
                            <img src="" alt="" />
                            <i class="bi playlistplay ri-play-circle-fill" id="26"></i>
                        </div>
                        <h5>text<br>
                            <div class="subtitle">text</div>
                        </h5>
                    ...
                    <li class="songItem">
                        <div class="img_play">
                            <img src="" alt="" />
                            <i class="bi playlistplay ri-play-circle-fill" id="27"></i>
                        </div>
                        <h5>text<br>
                            <div class="subtitle">text</div>
                        </h5>
                    ...
                    <li class="songItem">
                        <div class="img_play">
                            <img src="" alt="" />
                            <i class="bi playlistplay ri-play-circle-fill" id="28"></i>
                        </div>
                        <h5>text<br>
                            <div class="subtitle">text</div>
                        </h5>
                    ...
                    <li class="songItem">
                        <div class="img_play">
                            <img src="" alt="" />
                            <i class="bi playlistplay ri-play-circle-fill" id="29"></i>
                        </div>
                        <h5>text<br>
                            <div class="subtitle">text</div>
                        </h5>
                    ...
                    <li class="songItem">
                        <div class="img_play">
                            <img src="" alt="" />
                            <i class="bi playlistplay ri-play-circle-fill" id="30"></i>
                        </div>
                        <h5>text<br>
                            <div class="subtitle">text</div>
                        </h5>
            ...
            <div class="popular_artists">
                <div class="h4">
                    ...
                    <div class="btn_song">
                        <i class="bi ri-arrow-left-line" id="pop_art_left"></i>
                        <i class="bi ri-arrow-right-line" id="pop_art_right"></i>
                    </div>
                </div>
                <div class="item art">

                    <li>
                        <a href="arjit.html"><img src="imgartist/hoangthuylinh.jpg" alt=""></a>
                    </li>
                    <li>
                        <img src="imgartist/mck.jpg" alt="">
                    </li>
                    <li>
                        <img src="imgartist/vu.png" alt="">
                    </li>
                    <li>
                        <img src="imgartist/huynhjames.jpg" alt="">
                    </li>
                    <li>
                        <img src="imgartist/amee.jpg" alt="">
                    </li>
                    <li>
                        <img src="imgartist/sontung.jpg" alt="">
                    </li>
                    <li>
                        <img src="imgartist/tlinh.jpg" lt="">
                    </li>
                    <li>
                        <img src="imgartist/mono.jpg" alt="">
                    </li>
                    <li>
                        <img src="imgartist/denvau.jpg" alt="">
                    </li>
                    <li>
                        <img src="imgartist/chipu.jpg" alt="">
                    </li>
        ...
        <div class="audio-control high">
            ...
            <div class="audio-range">
                ...
                <div class="icon_back">
                    ...
                    <i class="ri-heart-add-line" id="playlist"></i>
